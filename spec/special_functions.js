export const arr_generator = (size = 7, level = 0) => {
  ...
  //С каждым следующим уровнем, шанс "числа" увеличивается на 5%, шанс "массива" уменьшается на 5%. Массив создается рекурсивно
